 ...
 */
#ifndef V1_COMMONAPI_EXAMPLES_ATTRIBUTES_SOMEIP_PROXY_HPP_
#define V1_COMMONAPI_EXAMPLES_ATTRIBUTES_SOMEIP_PROXY_HPP_
...
class AttributesSomeIPProxy
    : virtual public AttributesProxyBase,
      virtual public CommonAPI::SomeIP::Proxy {
public:
    AttributesSomeIPProxy(
        const CommonAPI::SomeIP::Address &_address,
        const std::shared_ptr<CommonAPI::SomeIP::ProxyConnection> &_connection);

    virtual ~AttributesSomeIPProxy();
...
#endif // V1_COMMONAPI_EXAMPLES_Attributes_SOMEIP_PROXY_HPP_
